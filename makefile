#############################################################
F90=mpif90
OPTIONS    = -c -real-size 64 -O2 -g -traceback -check bounds -openmp 
LOPTIONS   = -O2 -g -traceback -check bounds -openmp 
##############################################################
...
alloc_pt.o : alloc_pt.for module_imbub.o module_multidata.o module_mpi.o module_vars.o 
averaging.o : averaging.for module_vars.o module_multidata.o 
bounds.o : bounds.for module_mpi.o module_multidata.o module_vars.o 
...
flosol.o : flosol.for module_imbub.o module_multidata.o module_mpi.o module_vars.o 
initial.o : initial.for module_mpi.o module_multidata.o module_vars.o 
init_particle.o : init_particle.for module_imbub.o module_vars.o module_mpi.o module_multidata.o 
localparameters.o : localparameters.for module_multidata.o module_mpi.o module_vars.o 
IMBubbles.o : IMBubbles.for module_imbub.o module_vars.o module_mpi.o module_multidata.o  
...
module_imbub.o : module_imbub.for
