...
!!!!
        ...
        tr1=1.0*(fi(i-1,j-1,k)+fi(i-1,j-1,k+1))
        tr2=1.0*(fi(i,j-1,k)+fi(i,j-1,k+1))
        tr3=1.0*(fi(i+1,j-1,k)+fi(i+1,j-1,k+1))
        tr4=1.0*(fi(i-1,j,k)+fi(i-1,j,k+1))
        tr5=1.0*(fi(i,j,k)+fi(i,j,k+1))
        tr6=1.0*(fi(i+1,j,k)+fi(i+1,j,k+1))
        tr7=1.0*(fi(i-1,j+1,k)+fi(i-1,j+1,k+1))
        tr8=1.0*(fi(i,j+1,k)+fi(i,j+1,k+1))
        tr9=1.0*(fi(i+1,j+1,k)+fi(i+1,j+1,k+1))
